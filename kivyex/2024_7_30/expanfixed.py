...
class MDExpansionPanel(DeclarativeBehavior, BoxLayout):
    ...
    def open(self, *args) -> None:
        ...
        """
        # Clock.schedule_once(self._set_content_height)
        ...
        if not self._panel_is_process_opening:
            ...
            print("open time", self.opening_time)
            # Clock.schedule_once(self._set_content_height, self.opening_time)
            anim_height = Animation(
            ...
            anim_height.start(self._content)
            print("self content", self._content, "need self._content.on_start", self )
            # # print("animtion over")
            # # self._set_content_height()
            # print("correct height", self._content.height)
            # self.add_widget(self._content)
    ...
    def add_widget(self, widget, index=0, canvas=None):
        if isinstance(widget, MDExpansionPanelHeader):
            ...
            print("printing", self._content.height)
            # Clock.schedule_once(self._set_content_height, 0.8)
            # Clock.schedule_once(self._set_content_height, 2)
        elif (
            isinstance(widget, MDExpansionPanelContent)
            ...
            return super().add_widget(widget)
            # pass
        print("total add widget calls")

    def _set_content_height(self, *args):
        print("_set_content_height", self._content.height) #self._set_content_height,
